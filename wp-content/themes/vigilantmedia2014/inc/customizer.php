...
function vigilantmedia2014_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'featured_content_layout', array(
		'default'           => 'grid',
		'sanitize_callback' => 'vigilantmedia2014_sanitize_layout',
	) );
...
add_action( 'customize_register', 'vigilantmedia2014_customize_register' );
 ...
 */
function vigilantmedia2014_sanitize_layout( $layout ) {
...
add_action( 'customize_preview_init', 'vigilantmedia2014_customize_preview_js' );
...
add_action( 'admin_head-themes.php', 'vigilantmedia2014_contextual_help' );
add_action( 'admin_head-edit.php',   'vigilantmedia2014_contextual_help' );
