 ...
 */
function vigilantmedia_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'vigilantmedia_page_menu_args' );

/**
 * Register our footer widget area
 */
function vigilantmedia_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Footer', 'vigilantmedia' ),
		'id' => 'sidebar-1',
...
add_action( 'widgets_init', 'vigilantmedia_widgets_init' );
?>
